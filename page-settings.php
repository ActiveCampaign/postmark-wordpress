...
<div class="wrap">
	...
	<div class="tab-content tab-test">
		<table class="form-table">
			...
			<tr>
				<td colspan="2">
					<input type="checkbox" name="with_tracking_and_html" class="pm-test-with-opens" value="" />
					Send test as HTML, with both Open Tracking and Link Tracking enabled, and a Tag.
				</td>
			</tr>
		</table>
