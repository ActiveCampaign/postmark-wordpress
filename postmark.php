...
* Plugin URI: https://wordpress.org/plugins/postmark-approved-wordpress-plugin/
* Description: Overwrites wp_mail to send emails through Postmark
* Version: 1.9.6
* Author: Andrew Yates & Matt Gibbs
* Author URI: https://postmarkapp.com
* Requires at least: 4.4
* Tested up to: 4.8 *
* Text Domain: postmark
* GitHub Plugin URI: https://github.com/wildbit/postmark-wordpress
